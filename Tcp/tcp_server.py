...
class ScribbleTCPServer:
    def __init__(self):
        self.log_file = open("../metrics/tcp_metrics.txt", "w")
...
async def main():
    server = ScribbleTCPServer()
    server_tcp = await asyncio.start_server(server.handle_client,ADDRESS,PORT)
